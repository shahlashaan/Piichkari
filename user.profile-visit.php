                    ...
                    <div class="container px-6">
                        <div class="pp-gallery">
                            <div class="card-columns">
                                <div class="card"><a href="user.profile-visit.image-details.php">
                                    <figure class="pp-effect"><img class="img-fluid" src="images/1-nature.jpg"
                                                                   alt="Nature"/>
                                        <figcaption>
                                ...
                                <div class="card"><a href="user.profile-visit.image-details.php">
                                    <figure class="pp-effect"><img class="img-fluid" src="images/2-nature.jpg"
                                                                   alt="Nature"/>
                                        <figcaption>
                                ...
                                <div class="card"><a href="user.profile-visit.image-details.php">
                                    <figure class="pp-effect"><img class="img-fluid" src="images/4-nature.jpg"
                                                                   alt="Nature"/>
                                        <figcaption>
                                ...
                                <div class="card"><a href="user.profile-visit.image-details.php">
                                    <figure class="pp-effect"><img class="img-fluid" src="images/5-nature.jpg"
                                                                   alt="Nature"/>
                                        <figcaption>
                                ...
                                <div class="card"><a href="user.profile-visit.image-details.php">
                                    <figure class="pp-effect"><img class="img-fluid" src="images/8-nature.jpg"
                                                                   alt="Nature"/>
                                        <figcaption>
                                            <div class="h4">Bird</div>
                                        </figcaption>
                                ...
                                <div class="card"><a href="user.profile-visit.image-details.php">
                                    <figure class="pp-effect"><img class="img-fluid" src="images/9-nature.jpg"
                                                                   alt="Nature"/>
                                        <figcaption>
